...
<1> The service name of the Flow application. The same as the Flow Custom Resource (CR) name.
...
Additional flow configuration can be achieved by providing additional parameters using the `OPTIONS` environment variable.
