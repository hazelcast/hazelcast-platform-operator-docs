...
:description: This section describes Hazelcast’s Jet engine specific configuration using Hazelcast Platform Operator.

{description}

== Enabling Jet Engine
When you run Hazelcast using Platform Operator, Jet Engine is enabled by default.

== Enabling Resource Uploads
You can enable resource uploads using the following configuration:

.Example configuration
[source,yaml,subs="attributes+"]
----
include::ROOT:example$/jet-engine-resource-upload-enabled-configuration.yaml[]
----
