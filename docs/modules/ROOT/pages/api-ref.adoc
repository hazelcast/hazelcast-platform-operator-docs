...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "5.16.0"
...
m| version | Version of Hazelcast Platform. m| string | false | "5.6.0"
...
m| agent | B&R Agent configurations m| <<AgentConfiguration,AgentConfiguration>> | false | {repository: "docker.io/hazelcast/platform-operator-agent", version: "5.16.0"}
...
m| version | Version of Management Center. m| string | false | "5.9.0"
