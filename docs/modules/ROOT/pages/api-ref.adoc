...
* <<Phase,Phase>>
* <<RestoreAgentConfiguration,RestoreAgentConfiguration>>
...
m| restore | Restore Agent configuration m| &#42;<<RestoreAgentConfiguration,RestoreAgentConfiguration>> | false | {}
|===
...
m| agentVersion | Version of Hazelcast Platform Operator Agent. m| string | false | "1.0.0"
m| bucketSecret | Name of the secret with credentials for cloud providers. m| string | false | -
m| bucketPath | Full path to blob storage bucket. m| string | false | -
|===
