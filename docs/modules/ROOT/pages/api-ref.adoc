...
|===
| Field | Description | Type | Required | Default
m| name | ResourceName is the name of custom resource which WAN replication will be applied to. m| string | true | -
m| kind | ResourceKind is the type of custom resource which WAN replication will be applied to. m| <<ResourceKind,ResourceKind>> | true | -
|===
...
|===
| Field | Description | Type | Required | Default
m| resources | Resources is the list of custom resources which WAN replication will be applied to. m| []<<ResourceSpec,ResourceSpec>> | true | -
