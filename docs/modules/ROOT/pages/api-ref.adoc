...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "0.1.19"
|===
...
m| version | Version of Hazelcast Platform. m| string | false | "5.3.0-BETA-2"
...
m| agent | B&R Agent configurations m| <<AgentConfiguration,AgentConfiguration>> | false | {repository: "docker.io/hazelcast/platform-operator-agent", version: "0.1.19"}
...
m| bucketConfig | Bucket Configuration from which the JAR files be downloaded and accessible for the member. These JAR files will not be placed in the CLASSPATH. m| &#42;<<BucketConfiguration,BucketConfiguration>> | false | -
...
|===
| Field | Description | Type | Required | Default
m| cooperativeThreadCount | The number of threads Jet creates in its cooperative multithreading pool. m| int32 | false | -
...
m| maxProcessorAccumulatedRecords | Specifies the maximum number of records that can be accumulated by any single processor instance. m| int64 | false | -
|===
...
m| bucketConfig | Bucket Configuration from which the JAR files specified in JarName be downloaded and the jor will be run. m| &#42;<<BucketConfiguration,BucketConfiguration>> | false | -
|===
...
m| remoteURLs | List of URLs. Files downloaded from the URLs will be put under Java CLASSPATH. m| []string | false | -
|===
