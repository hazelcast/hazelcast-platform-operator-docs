...
* <<ExternalConnectivityServiceType,ExternalConnectivityServiceType>>
...
* <<IndexType,IndexType>>
* <<InitContainerConfiguration,InitContainerConfiguration>>
...
* <<JVMDebugConfiguration,JVMDebugConfiguration>>
...
* <<NearCacheMaxSizePolicyType,NearCacheMaxSizePolicyType>>
* <<NodeState,NodeState>>
...
* <<PrometheusFilterMetrics,PrometheusFilterMetrics>>
* <<PrometheusMonitoring,PrometheusMonitoring>>
* <<PrometheusPrinter,PrometheusPrinter>>
...
m| clientServerSocketEndpointConfig | &#160; m| <<ClientServerSocketEndpointConfig,ClientServerSocketEndpointConfig>> | false | -
...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "5.19.0"
...
m| uniqueKeyTransformation | &#160; m| <<UniqueKeyTransformation,UniqueKeyTransformation>> | true | -
|===
...
m| bucketURI | URL of the bucket to download folders. AWS S3, GCP Bucket and Azure Blob storage buckets are supported. Example bucket URIs: - AWS S3     -> s3://bucket-name/path/to/folder - GCP Bucket -> gs://bucket-name/path/to/folder - Azure Blob -> azblob://bucket-name/path/to/folder m| string | true | -
|===
==== Deprecated
[cols="4,8,4,2,4"options="header"]
|===
...
BucketSource defines the configuration for a single cloud storage bucket.
...
ClientTLS is used for client TLS configuration in Hazelcast CR
...
m| keyMaterialDuration | &#160; m| &#42;https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#duration-v1-meta[metav1.Duration] | false | -
|===
==== Deprecated
[cols="4,8,4,2,4"options="header"]
|===
...
|===
| Field | Description | Type | Required | Default
m| hazelcastReady | &#160; m| bool | false | -
m| state | &#160; m| string | false | -
|===
...
|===
| Field | Description | Type | Required | Default
m| serviceType | How Management Center is exposed. Valid values are: - "ClusterIP" - "NodePort" - "LoadBalancer" (default) m| <<ExternalConnectivityServiceType,ExternalConnectivityServiceType>> | false | -
...
|===
| Field | Description | Type | Required | Default
m| type | type is a deprecated alias for serviceType. m| <<ExternalConnectivityServiceType,ExternalConnectivityServiceType>> | false | -
|===
...
m| tls | TLS client configuration. m| &#42;<<MCClientTLS,MCClientTLS>> | false | -
...
m| version | Version of Hazelcast Platform. m| string | false | "5.7.1"
...
m| agent | B&R Agent configurations m| <<AgentConfiguration,AgentConfiguration>> | false | -
m| initContainer | InitContainer configurations. m| &#42;<<InitContainerConfiguration,InitContainerConfiguration>> | false | -
...
m| loggingConfiguration | LoggingConfiguration specify the logging configuration file to be mounted to the Hazelcast members. m| &#42;<<LoggingConfiguration,LoggingConfiguration>> | false | -
...
m| envFrom | EnvFrom defines sources to populate environment variables in the Hazelcast container. Allows referencing entire ConfigMaps or Secrets. m| []https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#envfromsource-v1-core[corev1.EnvFromSource] | false | -
...
m| ipFamily | IPFamily selects the network stack for Hazelcast members. m| <<IPFamily,IPFamily>> | false | IPv4
m| moduleDeployment | ModuleDeployment defines the modules to Download into CLASSPATH m| &#42;<<ModuleDeploymentConfiguration,ModuleDeploymentConfiguration>> | false | -
|===
==== Deprecated
[cols="4,8,4,2,4"options="header"]
|===
...
m| catalogPersistenceEnabled | &#160; m| bool | false | -
|===
...
m| attributes | Attributes of the index. At least one attribute is required; duplicates are not allowed. m| []string | true | -
m| bitMapIndexOptions | Options for "BITMAP" index type only. See https://docs.hazelcast.com/hazelcast/latest/query/indexing-maps#configuring-bitmap-indexes m| &#42;<<BitmapIndexOptionsConfig,BitmapIndexOptionsConfig>> | false | -
|===

<<Table of Contents,Back to TOC>>

=== InitContainerConfiguration
...
|===
| Field | Description | Type | Required | Default
m| resources | Compute Resources required by the Hazelcast init container. m| &#42;https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#resourcerequirements-v1-core[corev1.ResourceRequirements] | false | -
|===
...
m| debug | Debug configures remote JVM debugging. m| &#42;<<JVMDebugConfiguration,JVMDebugConfiguration>> | false | -
|===

<<Table of Contents,Back to TOC>>

=== JVMDebugConfiguration

JVMDebugConfiguration configures remote JVM debugging via JDWP.

[cols="4,8,4,2,4"options="header"]
|===
| Field | Description | Type | Required | Default
m| enabled | Enabled turns on JVM debug mode. m| &#42;bool | false | -
m| port | Port is the TCP port the JVM listens on for debugger connections (listen mode) m| &#42;int32 | false | 5005
m| suspend | Suspend when true blocks JVM startup until a debugger connects. Pods may remain NotReady until a debugger attaches m| &#42;bool | false | -
m| attach | Attach is the host:port of a listening debugger (attach mode). When set, the JVM connects out to the debugger instead of listening in the pod m| string | false | -
|===
...
m| bucketConfigs | Bucket configs from where the JAR files will be downloaded. m| []<<BucketSource,BucketSource>> | false | -
...
m| hazelcastResourceName | HazelcastResourceName defines the name of the Hazelcast resource that JetJobSnapshot is applied to. m| string | false | -
|===
...
m| resources | Compute Resources required by the Hazelcast container. m| &#42;https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#resourcerequirements-v1-core[corev1.ResourceRequirements] | false | -
m| env | Env configuration of environment variables m| []https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#envvar-v1-core[corev1.EnvVar] | false | -
m| envFrom | EnvFrom defines sources to populate environment variables in the Hazelcast lite member container. Allows referencing entire ConfigMaps or Secrets. m| []https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#envfromsource-v1-core[corev1.EnvFromSource] | false | -
|===
...
LoggingConfiguration specify the file to be mounted as logging configuration.

[cols="4,8,4,2,4"options="header"]
|===
| Field | Description | Type | Required | Default
m| configMapKeyRef | &#160; m| https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#configmapkeyselector-v1-core[corev1.ConfigMapKeySelector] | false | -
|===
...
MCClientTLS is used by Management Center CR, MC has nothing to do with MemberAuthentication
...
m| version | Version of Management Center. m| string | false | "5.11.1"
...
m| externalConnectivity | Configuration to expose Management Center to outside. m| &#42;<<ExternalConnectivityConfiguration,ExternalConnectivityConfiguration>> | false | {serviceType: "LoadBalancer"}
...
m| env | Env configuration of environment variables m| []https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#envvar-v1-core[corev1.EnvVar] | false | -
m| moduleDeployment | ModuleDeployment defines the modules to Download into MC_CLASSPATH m| &#42;<<ModuleDeploymentConfiguration,ModuleDeploymentConfiguration>> | false | -
m| agent | Agent configurations is the configuration for the InitContainer. m| <<AgentConfiguration,AgentConfiguration>> | false | -
m| serviceAccountName | ServiceAccountName is the name of the ServiceAccount to use to run InitContainer for ManagementCenter. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/ m| string | false | -
m| prometheusMonitoring | PrometheusMonitoring configures the integration with Prometheus. m| &#42;<<PrometheusMonitoring,PrometheusMonitoring>> | false | -
|===
...
m| eviction | Configuration for removing data from the map when it reaches its max size. It can be updated. m| <<EvictionConfig,EvictionConfig>> | false | -
...
m| eviction | NearCacheEviction specifies the eviction behavior in Near Cache m| <<NearCacheEviction,NearCacheEviction>> | true | -
m| cacheLocalEntries | CacheLocalEntries specifies whether the local entries are cached m| &#42;bool | false | false
m| serializeKeys | SerializeKeys specifies whether NearCache key in serialized format or by-reference. m| &#42;bool | false | false
|===
...
|===
| Field | Description | Type | Required | Default
m| evictionPolicy | EvictionPolicy to be applied when near cache reaches its max size according to the max size policy. m| <<EvictionPolicyType,EvictionPolicyType>> | false | "LRU"
m| maxSizePolicy | MaxSizePolicy for deciding if the maxSize is reached. m| <<NearCacheMaxSizePolicyType,NearCacheMaxSizePolicyType>> | false | "ENTRY_COUNT"
...
|===
| Field | Description | Type | Required | Default
m| timestampEnabled | TimestampEnabled configures whether to send timestamp of the individual members' metrics to Prometheus. m| bool | true | true
m| filterMetrics | FilterMetrics configure metrics in the /metrics endpoint. m| <<PrometheusFilterMetrics,PrometheusFilterMetrics>> | false | -
m| printers | Printers configure the set of metrics to expose. m| []<<PrometheusPrinter,PrometheusPrinter>> | false | -
|===

<<Table of Contents,Back to TOC>>

=== PrometheusFilterMetrics
...
|===
| Field | Description | Type | Required | Default
m| included | Included configure metrics to include in the /metrics endpoint. m| []string | false | -
m| excluded | Excluded configure metrics to exclude from the /metrics endpoint. m| []string | false | -
|===
...
|===
| Field | Description | Type | Required | Default
m| credentialsSecretName | CredentialsSecretName is the name of the secret that contains username and password basic authentication to secure the scrape endpoint. If the CredentialsSecretName is not set, the basic authentication on the scrape endpoint will be disabled. m| string | false | -
m| exporter | Exporter configures the reformating of all Hazelcast cluster metrics for compatibility with Prometheus. m| <<PrometheusExporter,PrometheusExporter>> | true | -
|===
...
|===
| Field | Description | Type | Required | Default
m| bucketConfig | bucketConfig is deprecated. Use bucketConfigs instead. Bucket config from where the JAR files will be downloaded. m| &#42;<<BucketConfiguration,BucketConfiguration>> | false | -
|===
...
EvictionPolicyType represents the eviction policy to be applied.
...
=== ExternalConnectivityServiceType

ExternalConnectivityServiceType describes how Management Center is exposed.
...
=== NearCacheMaxSizePolicyType

NearCacheMaxSizePolicyType represents the max-size policy for NearCache. Only supports policies compatible with NearCache (excludes heap-based policies).

[cols="5,10"options="header"]
|===
| Value | Description
m| "ENTRY_COUNT" | NearCacheMaxSizePolicyEntryCount Maximum size based on the entry count in the Near Cache
m| "USED_NATIVE_MEMORY_SIZE" | NearCacheMaxSizePolicyUsedNativeMemorySize Maximum used native memory size in megabytes per map for each Hazelcast instance. Available only in Hazelcast Enterprise HD.
m| "USED_NATIVE_MEMORY_PERCENTAGE" | NearCacheMaxSizePolicyUsedNativeMemoryPercentage Maximum used native memory size percentage per map for each Hazelcast instance. Available only in Hazelcast Enterprise HD.
m| "FREE_NATIVE_MEMORY_SIZE" | NearCacheMaxSizePolicyFreeNativeMemorySize Minimum free native memory size in megabytes for each Hazelcast instance. Available only in Hazelcast Enterprise HD.
m| "FREE_NATIVE_MEMORY_PERCENTAGE" | NearCacheMaxSizePolicyFreeNativeMemoryPercentage Minimum free native memory size percentage for each Hazelcast instance. Available only in Hazelcast Enterprise HD.
|===
