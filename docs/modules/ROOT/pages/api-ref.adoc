...
* <<CustomClassConfiguration,CustomClassConfiguration>>
...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "0.1.5"
|===
...
m| secret | Name of the secret with credentials for cloud providers. m| string | true | -
m| bucketURI | Full path to blob storage bucket. m| string | true | -
m| triggerSequence | A string for triggering a rolling restart for re-downloading the custom classes. m| string | false | -
|===
...
m| version | Version of Hazelcast Platform. m| string | false | "5.1.2"
...
m| agent | B&R Agent configurations m| &#42;<<AgentConfiguration,AgentConfiguration>> | false | {repository: "docker.io/hazelcast/platform-operator-agent", version: "0.1.5"}
...
m| version | Version of Management Center. m| string | false | "5.1.3"
