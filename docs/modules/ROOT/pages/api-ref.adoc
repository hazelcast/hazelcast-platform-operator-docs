...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "0.1.21"
|===
...
m| version | Version of Hazelcast Platform. m| string | false | "5.3.1"
...
m| agent | B&R Agent configurations m| <<AgentConfiguration,AgentConfiguration>> | false | {repository: "docker.io/hazelcast/platform-operator-agent", version: "0.1.21"}
...
m| version | Version of Management Center. m| string | false | "5.3.1"
