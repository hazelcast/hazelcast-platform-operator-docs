...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "0.1.4"
|===
...
m| agent | B&R Agent configurations m| &#42;<<AgentConfiguration,AgentConfiguration>> | false | {repository: "docker.io/hazelcast/platform-operator-agent", version: "0.1.4"}
