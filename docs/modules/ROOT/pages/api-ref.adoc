...
* <<HazelcastRef,HazelcastRef>>
* <<HazelcastReference,HazelcastReference>>
...
|===
| Field | Description | Type | Required | Default
m| name | Name of Hazelcast CR m| string | true | -
m| namespace | Namespace of Hazelcast CR m| string | false | "default"
|===
...
|===
| Field | Description | Type | Required | Default
m| clusterAddress | Address of the Hazelcast cluster m| &#42;string | false | -
m| cluster | Reference to Hazelcast CR m| &#42;<<HazelcastRef,HazelcastRef>> | false | -
|===
...
|===
| Field | Description | Type | Required | Default
m| portName | The name of the container port that Turbine will register m| &#42;string | false | -
|===
...
|===
| Field | Description | Type | Required | Default
m| name | Name of the Turbine sidecar container m| string | false | "turbine-sidecar"
m| repository | Repository of the image used for Turbine sidecar container m| string | false | "hazelcast/turbine-sidecar"
m| version | Version of the image used for Turbine sidecar container m| string | false | "latest"
|===
...
| Field | Description | Type | Required | Default
m| metadata | &#160; m| https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#objectmeta-v1-meta[metav1.ObjectMeta] | false | -
m| spec | &#160; m| <<TurbineSpec,TurbineSpec>> | false | -
|===
...
| Field | Description | Type | Required | Default
m| metadata | &#160; m| https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#listmeta-v1-meta[metav1.ListMeta] | false | -
m| items | &#160; m| []<<Turbine,Turbine>> | true | -
|===
...
|===
| Field | Description | Type | Required | Default
m| sidecar | Sidecar configuration m| &#42;<<SidecarConfiguration,SidecarConfiguration>> | false | {"name" : "turbine-sidecar"}
m| hazelcast | Hazelcast cluster to connect. If present, only one of "clusterAddress" or "cluster" must be defined. m| &#42;<<HazelcastReference,HazelcastReference>> | false | -
m| pods | Pod configuration m| &#42;<<PodConfiguration,PodConfiguration>> | false | -
|===
...
m| "ForceStart" | ForceStart deletes all data in your cluster members' persistence stores when the cluster recovery fails.
|===
