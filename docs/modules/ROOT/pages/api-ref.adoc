...
|===
| Field | Description | Type | Required | Default
m| memberCount | MemberCount is the number of CP members in the CP Subsystem. If not provided, all the Hazelcast members will become CP members. m| &#42;int32 | false | -
m| groupSize | GroupSize is the number of CP members to participate in each CP group. Must be an odd number between 3 and 7, and smaller than or equal to MemberCount. m| &#42;int32 | false | -
