...
|===
| Field | Description | Type | Required | Default
m| persistenceEnabled | Eviction policy to be applied when map reaches its max size according to the max size policy. m| types.EvictionPolicyType | false | "NONE"
