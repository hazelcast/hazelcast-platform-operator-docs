...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "0.1.15"
|===
...
m| version | Version of Hazelcast Platform. m| string | false | "latest-snapshot"
...
m| agent | B&R Agent configurations m| <<AgentConfiguration,AgentConfiguration>> | false | {repository: "docker.io/hazelcast/platform-operator-agent", version: "0.1.15"}
...
m| args | Args is for arbitrary garbage collection arguments m| []string | false | -
|===
