...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "5.15.0"
...
m| imagePullPolicy | Pull policy for the Flow image m| https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#pullpolicy-v1-core[corev1.PullPolicy] | false | "IfNotPresent"
m| imagePullSecrets | Image pull secrets for the Flow image m| []https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#localobjectreference-v1-core[corev1.LocalObjectReference] | false | -
...
m| version | Version of Hazelcast Platform. m| string | false | "5.5.4"
...
m| agent | B&R Agent configurations m| <<AgentConfiguration,AgentConfiguration>> | false | {repository: "docker.io/hazelcast/platform-operator-agent", version: "5.15.0"}
...
m| version | Version of Management Center. m| string | false | "5.7.1"
