...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "0.1.13"
|===
...
m| agent | B&R Agent configurations m| <<AgentConfiguration,AgentConfiguration>> | false | {repository: "docker.io/hazelcast/platform-operator-agent", version: "0.1.13"}
