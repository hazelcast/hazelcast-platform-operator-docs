...
m| version | Version of Hazelcast Platform Operator Agent. m| string | false | "0.1.7"
|===
...
m| version | Version of Hazelcast Platform. m| string | false | "5.1.4"
...
m| agent | B&R Agent configurations m| &#42;<<AgentConfiguration,AgentConfiguration>> | false | {repository: "docker.io/hazelcast/platform-operator-agent", version: "0.1.7"}
...
|===
| Field | Description | Type | Required | Default
m| state | &#160; m| <<MultiMapConfigState,MultiMapConfigState>> | false | -
m| message | &#160; m| string | false | -
m| memberStatuses | &#160; m| map[string]<<MultiMapConfigState,MultiMapConfigState>> | false | -
|===
...
|===
| Field | Description | Type | Required | Default
m| state | &#160; m| <<TopicConfigState,TopicConfigState>> | false | -
m| message | &#160; m| string | false | -
m| memberStatuses | &#160; m| map[string]<<TopicConfigState,TopicConfigState>> | false | -
|===
...
m| "Success" | &#160;
m| "Pending" | &#160;
m| "Persisting" | MultiMap config is added into all members but waiting for multiMap to be persisten into ConfigMap
m| "Terminating" | &#160;
|===
...
m| "Success" | &#160;
m| "Pending" | &#160;
m| "Persisting" | Topic config is added into all members but waiting for Topic to be persisten into ConfigTopic
m| "Terminating" | &#160;
|===
