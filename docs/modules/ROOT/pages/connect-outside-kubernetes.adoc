...
TIP: For a working example, see link:link:https://guides.hazelcast.org/hazelcast-platform-operator-expose-externally/main/[this tutorial].

== Before you Begin

You need a Hazelcast cluster, and the `kubectl` command-line tool must be configured to communicate with your cluster.
