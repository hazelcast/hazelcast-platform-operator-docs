...
<2> Specifies the name of the JetJob CR object which the Snapshot is exported from.
...
<1> Specifies the name of the JetJobSnapshot CR object which the JetJob is initialized from.
