...
To export a snapshot using the JetJobSnapshot custom resource
...
WARNING: The status of the JetJob, from which you want to export a Snapshot, must be equals to 'Running'.

== Starting a JetJob initialized from the Snapshot

To starting a new JetJob initialized from a Snapshot
