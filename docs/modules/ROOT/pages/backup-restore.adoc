...
You can check status of the Hot Backup task by running the folowing command.
[source,bash]
----
kubectl get hotbackup hot-backup
----

You should see the similar output that will indicate that the Hot Backup process finished successfully.
[source,bash]
----
NAME         STATUS
hot-backup   Success
