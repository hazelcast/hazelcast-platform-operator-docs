...
WARNING: Performing a force-start may result in the loss of all persistent data in the cluster. Additionally, executing a partial-start may lead to the loss of some persistent data.
