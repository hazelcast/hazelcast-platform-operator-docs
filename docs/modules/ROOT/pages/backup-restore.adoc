...
For triggering external Backup, you need to pass two additional configurations.
...
NOTE: You can <<status-backup, check the status of a Backup >> and <<schedule-backup, schedule external Backups >> same as the local ones
