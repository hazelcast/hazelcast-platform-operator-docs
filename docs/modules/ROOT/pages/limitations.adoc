...
Modifying the following parameters in the Hazelcast CR will not trigger a rolling update of the cluster. To apply configuration changes, you need to manually restart the Hazelcast pods.
