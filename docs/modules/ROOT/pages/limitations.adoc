...
* **Data Structure Operations:** Creating, modifying, or deleting data structures (Maps, Queues, Topics, MultiMaps, etc.) through Management Center or client APIs will not be tracked by the operator. Use the appropriate Custom Resources (e.g., `Map`, `Queue`, `Topic`, `MultiMap`) to manage data structures.
