...
You can find more detailed information on configuration of Serializartion in xref:api-ref.adoc#jetjobspec[API Reference] page.

== Configuraing Custom Serialization
...
== Configuraing Compact Serialization
