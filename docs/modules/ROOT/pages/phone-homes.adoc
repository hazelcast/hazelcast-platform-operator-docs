= Phone home data
:description: Each instance of Hazelcast Platform Operator reports usage data to the Hazelcast phone home server when a Custom Resource is successfully deployed and every 24 hours after that. Hazelcast uses this data to learn about the usage of Operator.
...
* Operator version
* Kubernetes distribution, such as EKS, GKE, AKS
* Kubernetes version
* Operator uptime
* Operator UID
* Operator installation origin, such as Dockerhub or Red Hat Connect
* Type of watched namespace scope, such as single, all, multi, own
...
** Number of backups using Kubernetes Persistent Volume Claims
