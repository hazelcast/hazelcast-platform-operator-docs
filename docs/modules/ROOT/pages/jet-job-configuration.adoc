...
For troubleshooting or verifying job deployments, you should review the sidecar agent logs in addition to the main Hazelcast member logs. See xref:logs.adoc[View logs].
