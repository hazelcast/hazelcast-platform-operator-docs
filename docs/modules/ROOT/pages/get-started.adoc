...
To deploy Hazelcast Platform Operator, use the following command to apply the https://repository.hazelcast.com/operator/bundle-{full-version}.yaml[`bundle.yaml`] file to your Kubernetes cluster:
