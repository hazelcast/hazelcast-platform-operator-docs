...
NOTE: If you want to use an existing `PersistentVolumeClaim`, in the ManagementCenter CR you can set its name in the field `.spec.persistence.existingVolumeClaimName`. 
