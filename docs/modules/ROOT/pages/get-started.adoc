...
To deploy Hazelcast Platform Operator, use the following command to apply the https://repository.hazelcast.com/operator/bundle.yaml[`bundle.yaml`] file to your Kubernetes cluster:
