= Get Started with Hazelcast Platform Operator
...
.Show bundle.yaml file
[%collapsible]
====
[source,yaml,subs="attributes+"]
....
include::ROOT:example$/bundle.yaml[]
....
====
...
NOTE: If you don't have Hazelcast Enterprise License Key, please check xref:{page-latest-supported-hazelcast}@hazelcast:deploy:using-enterprise-edition.adoc#requesting-a-license-key[Requesting a License Key]
