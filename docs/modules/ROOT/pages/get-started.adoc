...
NOTE: Unless the deployment is pinned to a specific Java version, the Operator defaults to the latest supported Java version.
...
For more information, see the xref:api-ref.adoc#hazelcaststatus[API reference].
