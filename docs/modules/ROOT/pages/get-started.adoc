...
+
--
To enable some features or dashboard at Management Center, you need require a license key. If you don't have a license key, you can request one from the link:http://trialrequest.hazelcast.com/[Hazelcast website].
