...
- Expose Management Center using Ingress defined on the https://kubernetes.io/docs/concepts/services-networking/ingress/[Ingress].
...
WARNING: The paths, consisting of multiple segments (e.g., "/hazelcast/mancenter"), are supported as of Management Center version 5.4.0.
