...
* Tutorials
** xref:hazelcast-platform-operator-external-backup-restore.adoc[Restore a cluster with Operator]
** xref:hazelcast-platform-operator-wan-replication.adoc[Replicate data between clusters with Operator]
** xref:hazelcast-platform-operator-wan-sync.adoc[Synchronize data between clusters using WAN Sync]
** xref:hazelcast-platform-operator-jet.adoc[Run a data pipeline using Jet with Operator]
** xref:hazelcast-platform-operator-jet-job-snapshot.adoc[Save the state of Jet job with Operator]
// placeholder ** xref:hazelcast-platform-operator-jet-job-snapshot.adoc[Save the state of Jet job with Operator]
