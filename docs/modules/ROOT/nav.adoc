...
* Tutorials
** xref:tutorials:hazelcast-platform-operator-external-backup-restore.adoc[Restore a cluster with Operator]
** xref:tutorials:hazelcast-platform-operator-wan-replication.adoc[Replicate data between clusters with Operator]
** xref:tutorials:hazelcast-platform-operator-wan-sync.adoc[Synchronize data between clusters using WAN Sync]
** xref:tutorials:hazelcast-platform-operator-jet.adoc[Run a data pipeline using Jet with Operator]
** xref:tutorials:hazelcast-platform-operator-jet-job-snapshot.adoc[Save the state of Jet job with Operator]
** xref:tutorials:hazelcast-platform-operator-tls.adoc[Secure a cluster with TLS using Operator]
** xref:tutorials:hazelcast-platform-operator-expose-externally.adoc[Connect to a cluster from outside of Kubernetes]
