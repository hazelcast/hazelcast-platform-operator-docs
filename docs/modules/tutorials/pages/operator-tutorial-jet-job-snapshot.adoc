...
----
kubectl apply -f - <<EOF
include::6.0-snapshot@hazelcast:ROOT:example$/jet/operator-jet-job-snapshot/hz.yaml[]
EOF
----
...
----
kubectl apply -f - <<EOF
include::6.0-snapshot@hazelcast:ROOT:example$/jet/operator-jet-job-snapshot/map.yaml[]
EOF
----
...
[source, java]
----
include::6.0-snapshot@hazelcast:ROOT:example$/jet/operator-jet-job-snapshot/jet-pipelines/src/main/java/org/examples/jet/snapshot/JobV1.java[]
----
...
----
kubectl apply -f - <<EOF
include::6.0-snapshot@hazelcast:ROOT:example$/jet/operator-jet-job-snapshot/job-v1.yaml[]
EOF
----
...
----
kubectl apply -f - <<EOF
include::6.0-snapshot@hazelcast:ROOT:example$/jet/operator-jet-job-snapshot/snapshot.yaml[]
EOF
----
...
[source, java]
----
include::6.0-snapshot@hazelcast:ROOT:example$/jet/operator-jet-job-snapshot/jet-pipelines/src/main/java/org/examples/jet/snapshot/JobV2.java[]
----
...
----
kubectl apply -f - <<EOF
include::6.0-snapshot@hazelcast:ROOT:example$/jet/operator-jet-job-snapshot/job-v2.yaml[]
EOF
----
